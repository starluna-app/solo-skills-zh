...
class ExecutionTracker {
    ...
    recordSessionStart(taskId, julesSessionId) {
    ...
    updateSessionState(taskId, newState, additionalInfo) {
        const record = this.sessions.get(taskId);
        if (record) {
