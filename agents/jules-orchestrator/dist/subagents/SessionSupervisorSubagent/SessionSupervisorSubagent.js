...
exports.SessionSupervisorSubagent = exports.SessionSupervisorScope = void 0;
exports.SessionSupervisorScope = {
    decisions: [
...
class SessionSupervisorSubagent {
    input;
    skills;
    llm;
    logger;
    id;
    scope = exports.SessionSupervisorScope;
    questionsAsked = 0;
    constructor(input, skills, llm, logger) {
        this.input = input;
        this.skills = skills;
        this.llm = llm;
        this.logger = logger;
...
exports.SessionSupervisorSubagent = SessionSupervisorSubagent;
